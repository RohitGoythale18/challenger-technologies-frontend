...
const Sidebar = ({ isOpen, onClose }) => {
    return (
        <div className={`fixed top-0 left-0 h-full w-64 bg-gray-300 shadow-lg z-50 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
